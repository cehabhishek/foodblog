var app = {
        ...
        ajax: {
            ...
            error: {
                html:
                    '<div class="px-3 text-center fs-20px"><i class="fa fa-warning fa-lg text-muted me-1"></i> <span class="fw-600 text-inverse">Error 404! Page not found.</span></div>'
            }
        },
        header: {
            id: "#header",
    ...
    handleSidebarMenu = function() {
        ...
        var n = t + s + s,
            p = [].slice.call(
                document.querySelectorAll(
                    n + " > ." + app.sidebar.menu.itemLinkClass
                )
            );
    ...
    handleUnlimitedTopMenuRender = function() {
        ...
        function a() {
            ...
            if (e) {
                ...
                if (i) {
                    ...
                    i.map(function(e) {
                        e.classList.contains("menu-control") ||
                            ((r += e.clientWidth),
                            n || (o += e.clientWidth),
                            e.classList.contains("active") && (n = !0));
                    });
                }
                if (o >= l) {
                    var p = o - l + 128;
                ...
                o != r && r >= l
                    ? c.classList.add(app.topMenu.control.showClass)
                    : c.classList.remove(app.topMenu.control.showClass);
                c = e.querySelector(
                    "." +
                        app.topMenu.control.class +
                        "." +
        ...
        (t = document.querySelector(
            ...
            window.addEventListener("resize", function() {
                ...
                e && e.removeAttribute("style"),
                    document.body.clientWidth > 767 && a();
            }),
            a();
    },
                    ...
                    if (
                        ...
                        if (t) {
                            ...
                            if (
                                ...
                                if (i > d && m)
                                    for (
                                        var b = app.sidebar.floatSubmenu.overflow.class.split(
                                                " "
                                            ),
                                            g = 0;
                                        g < b.length;
                                        ...
                                        m.classList.add(b[g]);
                                u.setAttribute("data-offset-top", n),
                                    u.setAttribute("data-menu-offset-top", n),
                                    (m.innerHTML = t);
                            } else {
                                var h = "";
                                i > d &&
    ...
    handleSetPageOption = function(e) {
        ...
        if (a) {
            ...
            if (
                ...
                e.appSidebarLight &&
                    a.classList.add(app.layout.sidebarLight.class),
            ...
            if (e.appWithoutHeader)
                a.classList.add(app.layout.withoutHeader.class),
                    (t = document.querySelector("." + app.header.class)) &&
            ...
            if (e.appWithoutSidebar)
                a.classList.add(app.layout.withoutSidebar.class),
                    ...
                    (t = document.querySelector("." + app.sidebar.class)) &&
                        (t.style.display = "none"),
                    (t = document.querySelector("." + app.sidebar.bg.class)) &&
                        (t.style.display = "none"),
                    (t = document.querySelector(
            ...
            if (e.appHeaderInverse)
                (t = document.querySelector("." + app.header.class)) &&
                    t.classList.add(app.header.inverse.class);
            if (e.pageContentFullWidth)
                (t = document.querySelector("." + app.content.class)) &&
                    t.classList.add(app.content.fullWidth.class);
            if (e.appClass)
                for (var s = e.appClass.split(" "), l = 0; l < s.length; l++)
                    a.classList.add(s[l]);
            if (e.appContentClass)
                if ((t = document.querySelector("." + app.content.class)))
                    for (
                        s = e.appContentClass.split(" "), l = 0;
                        l < s.length;
                        l++
                    )
                        t.classList.add(s[l]);
            if (e.bodyClass)
                for (s = e.bodyClass.split(" "), l = 0; l < s.length; l++)
                    document.body.classList.add(s[l]);
            e.appBoxedLayout &&
    ...
    handleClearPageOption = function(e) {
        ...
        if (a) {
            ...
            if (
                ...
                e.appSidebarLight &&
                    a.classList.remove(app.layout.sidebarLight.class),
                e.appSidebarEnd &&
            ...
            if (e.appSidebarTransparent)
                (t = document.querySelector("." + app.sidebar.class)) &&
                    t.classList.remove(app.sidebar.transparent.class);
            ...
            if (e.appHeaderInverse)
                (t = document.querySelector("." + app.header.class)) &&
                    t.classList.remove(app.header.inverse.class);
            if (e.appWithoutSidebar)
            ...
            if (e.appContentFullWidth)
                (t = document.querySelector("." + app.content.class)) &&
                    t.classList.remove(app.content.fullWidth.class);
            if (e.appContentClass)
                if ((t = document.querySelector("." + app.content.class)))
                    for (
                        var s = e.appContentClass.split(" "), l = 0;
                        l < s.length;
                        l++
                    )
                        t.classList.remove(s[l]);
            if (e.appClass)
                for (s = e.appClass.split(" "), l = 0; l < s.length; l++)
                    a.classList.remove(s[l]);
            if (e.bodyClass)
                for (s = e.bodyClass.split(" "), l = 0; l < s.length; l++)
                    document.body.classList.remove(s[l]);
            e.appBoxedLayout &&
        ...
        return {
            ...
            initVariable: function() {
                (app.color.theme = getCssVariable("--app-theme")),
                    ...
                    (app.color.componentBg = getCssVariable(
                        "--app-component-bg"
                    )),
                    ...
                    (app.color.gray100Rgb = getCssVariable(
                        "--bs-gray-100-rgb"
                    )),
                    (app.color.gray200Rgb = getCssVariable(
                        "--bs-gray-200-rgb"
                    )),
                    (app.color.gray300Rgb = getCssVariable(
                        "--bs-gray-300-rgb"
                    )),
                    (app.color.gray400Rgb = getCssVariable(
                        "--bs-gray-400-rgb"
                    )),
                    (app.color.gray500Rgb = getCssVariable(
                        "--bs-gray-500-rgb"
                    )),
                    (app.color.gray600Rgb = getCssVariable(
                        "--bs-gray-600-rgb"
                    )),
                    (app.color.gray700Rgb = getCssVariable(
                        "--bs-gray-700-rgb"
                    )),
                    (app.color.gray800Rgb = getCssVariable(
                        "--bs-gray-800-rgb"
                    )),
                    (app.color.gray900Rgb = getCssVariable(
                        "--bs-gray-900-rgb"
                    )),
