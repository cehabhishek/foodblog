                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            <div class="btn-group me-1 mb-1">
                                <a href="#categoryEdit{{ $category->id }}" class="btn btn-primary"
                                    data-bs-toggle="modal"> <i class="fa fa-pencil"></i> Edit</a>
                                    
                                <a href="{{route('admin.category.delete',$category->id)}}" class="btn btn-danger" style="margin-left:10px" > <i class="fa fa-trash"></i> Delete</a>
                                </div>
                        </td>
            ...
            <table class="table table-striped table-bordered align-middle data-table-default">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>{{ $subCategory->show_in_menu }}</td>
                        <td>
                            <div class="btn-group me-1 mb-1">
                                <a href="#subCategoryEdit{{ $subCategory->id }}" class="btn btn-primary"
                                    data-bs-toggle="modal"> <i class="fa fa-pencil"></i> Edit</a>
                            </div>
                            <div class="btn-group me-1 mb-1">
                                <a href="{{route('admin.sub.category.delete',$subCategory->id)}}" class="btn btn-danger"> <i class="fa fa-trash"></i> Delete</a>
                            </div>
                        </td>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Short Description</label> <span
                                                            id="meta_description_word" style="font-weight: bold"></span>
                                                        <b class="text-danger" id="showError"></b>
                                                        <textarea class="form-control" name="short_description"
                                                            id="short_description" rows="5"
                                                            required>{{ $subCategory->short_description }}</textarea>
                                                    </div>
                                                </div>
