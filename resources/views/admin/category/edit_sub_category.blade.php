            ...
            <div class="col-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">Update Sub Cateogry</h4>
                        ...
                        <form action="{{ route('admin.subcategory.update', $subCategory->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="Enter category name"
                                            name="name" required value="{{ $subCategory->name }}" />
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter category title"
                                            name="title" required value="{{ $subCategory->title }}" />
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        @php
                                            $keywords = explode(',', $subCategory->keywords);
                                        @endphp
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        <textarea name="meta_description" class="form-control" placeholder="Enter description" rows="5">{{ $subCategory->meta_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
