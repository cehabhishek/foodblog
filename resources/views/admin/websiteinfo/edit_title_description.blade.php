            ...
            <div class="col-12">
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <form action="{{ route('admin.title.description.update', $data->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        <textarea name="meta_description" class="form-control" placeholder="Enter description" rows="5">{{ $data->meta_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
