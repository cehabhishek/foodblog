    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-link">
                    <a href="{{ route('admin.post.index') }}">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="widget widget-stats bg-info">
                ...
                <div class="stats-link">
                    <a href="{{ route('admin.cat.subcat.index') }}">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <h6><a href="javascript:;"
                                                class="text-dark text-decoration-none">Nunc eleifend lorem eu
                    ...
                    <div class="h-300px p-3" data-scrollbar="true">
                        <div class="d-flex">
                            ...
                            <div class="flex-1 ps-3">
                                ...
                                <span class="text-muted fs-11px fw-bold">Received on 04/16/2022,
                                    12.39pm</span>
                            </div>
                        </div>
                        <hr class="bg-gray-500" />
